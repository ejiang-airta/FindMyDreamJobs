...
def engine_extract(text, known_companies=None):
    ...
    # --- 1. TITLE EXTRACTION (Priority Engine) ---
    found_title = "Not found"
    
    # Priority A: Regex Headers
    ...
    # Priority B: Natural Language Phrases
    ...
    # Priority C: Keyword Scorer (Scans deeper for the first 30 lines)
    if found_title == "Not found":
        ...
        for i, line in enumerate(lines[:30]): 
            ...
            # Penalties to avoid picking up the "About" paragraph
            if any(x in line.lower() for x in ["about the job", "welcome", "stackadapt is", "redpanda is", "click", "apply"]):
                score -= 20
            
            # Gentle distance decay
            score -= (i * 0.5)
    ...
    # --- 2. COMPANY EXTRACTION (Robust Logic) ---
    found_company = "Not found"
    
    # A. "About [Company]" with Blacklist
    ...
    # B. Intro check: "[Company] is/empowers/pioneers..."
